...
public class DLog {
     ...
     * calling thread ID and method mName.
     */
    ...
    /**
     * A simple event log with records containing a mName, thread ID, and timestamp.
     */
    static class MarkerLog {
        ...
        /** Adds a marker to this log with the specified mName. */
